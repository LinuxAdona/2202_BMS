...
{
    $sql = "SELECT r.resident_id, r.first_name, r.middle_name, r.last_name, r.gender, r.contact_number, r.family_id, r.date_of_birth
            FROM family f
...
function getAddress($conn, $family_id)
{
