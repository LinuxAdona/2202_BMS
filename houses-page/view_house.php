...
<?php include "../brgy_management/tables/houses_info/info.php"; ?>
...
<body>
    ...
    $house = loadHouseDetails($conn, $address_id);
    ?>
            ...
            <ul>
                ...
                <div class="menu">
                    ...
                    <li class="active">
                        ...
                        echo "<a href='view_family.php?id=" . $family_id . "'>View Houses</a>";
                        ?>
                    </li>
                </div>
            </ul>
